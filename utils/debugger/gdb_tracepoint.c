                ...
                { 
                    ...
                    case COLLECT_MEMORY:  
                        { 
                              ...
                              current_collect_record->collect_data_length=sim_read (base_reg_val+current_action->action_data.ca.description.mc.offset, (unsigned char *)current_collect_record->collect_data, current_action->action_data.ca.description.mc.length);
                              current_collect_record->ca=&(current_action->action_data.ca);
                              current_collect_record->next=NULL;
                        } 
                        break;;
    ...
    { 
        ...
        { 
            ...
            case ACTION_UNASSIGNED:
                    printf("HUGHAGHLUGHALUGHGHUGLAGHAGLLUGH\n");
                    skyeye_exit(1337);
            break;
        } 
    } 
